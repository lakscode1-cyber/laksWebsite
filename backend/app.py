...
try:
    ...
    CORS(app, origins=["https://www.lakscode.com", "lakscode.com", "https://lakscode.com/", "http://localhost:3000", "http://localhost:5173"])
    print("CORS configured with specified origins.")
except ImportError:
